...
<input type="hidden" name="onum" value="${dto.onum + 1}">
<input type="hidden" name="nested" value="${dto.nested + 1}">  
...
<div class="panel panel-default table-responsive">
    ...
    <!-- Table -->
 	<table class="table table-sm" border="1">
  		<tr>
    		<th style="width: 10%">제목</th><td colspan="3"><input type="text" name="title" value="[Re]:${dto.title}"></td>
   		</tr>
   		<tr>
...
<div class="btn-group btn-group-sm" role="group" aria-label="...">
        	<button type="button" onclick="javascript:reformCheck()" class="btn btn-default">답글등록완료</button>
